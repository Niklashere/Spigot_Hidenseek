...
public class Layouts {
  ...
  public static void getBanner() {
    PluginDescriptionFile pdf = Bukkit.getServer().getPluginManager()
        .getPlugin("hidenseek").getDescription();
    ...
    System.out
        .println(".|_|..|_|_|\\__,_|\\___|.|_|.|_|.|___/\\___|\\___|_|\\_\\");
    System.out.println(
        "..............................................v" + pdf.getVersion());
    System.out.println(" ");
    ...
    System.out.println(" ");
    System.out.println(
        " Developed by Niklas Zabel. Licensed under GNU GPLv3 © 2021 - "
            + Year.now().getValue() + ".");
    System.out.println(" ");
  ...
  public static void getLanguage() {
    ...
    while (Fileaccess
        .getStringList("supported-languages", Fileaccess.getConfig()).size()
        - 1 >= i) {
      if (i >= 1) {
        languages = languages + ", "
            + Fileaccess
                .getStringList("supported-languages", Fileaccess.getConfig())
                .get(i);

      } else {
        languages = Fileaccess
            .getStringList("supported-languages", Fileaccess.getConfig())
            .get(i);
