    ...
    if (p.hasPermission("hidenseek.admin")) {
      ...
      inv.setItem(10, new ItemBuilder(Material.OAK_SIGN)
          ...
          .addLoreLine(VariableManager
              .message(LanguageManager.getMessage("setup.instruction-1", p), p))
          .addLoreLine(VariableManager
              .message(LanguageManager.getMessage("setup.instruction-2", p), p))
          .build());
      ...
      inv.setItem(12,
          new ItemBuilder(Material.ENDER_EYE)
              ...
              .addLoreLine(VariableManager.message(
                  LanguageManager.getMessage("setup.instruction-1", p), p))
              .addLoreLine(VariableManager.message(
                  LanguageManager.getMessage("setup.instruction-2", p), p))
              .build());
      inv.setItem(13,
      ...
      p.sendMessage(VariableManager
          .message(LanguageManager.getMessage("missing-permission", p), p));
    }
  }
}
